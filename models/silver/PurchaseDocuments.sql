WITH PurchaseDocuments AS (
  ...
  FROM  {{ source("source_db", "ekpo") }} AS ekpo
  INNER JOIN {{ source("source_db", "ekko") }} AS ekko
  ...
  LEFT JOIN {{ ref("calendar_date_dim") }} AS CalendarDateDimension_AEDAT
    ON CalendarDateDimension_AEDAT.Date = ekko.AEDAT
  LEFT JOIN {{ ref("calendar_date_dim") }} AS CalendarDateDimension_BEDAT
    ON CalendarDateDimension_BEDAT.Date = ekko.BEDAT
)

SELECT * FROM PurchaseDocuments